...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Events", LineAwesomeIcon.FILE.create(), EventsView.class), //

                new MenuItemInfo("My View2", LineAwesomeIcon.PENCIL_RULER_SOLID.create(), MyView2View.class), //
                ...
                new MenuItemInfo("My View3", LineAwesomeIcon.PENCIL_RULER_SOLID.create(), MyView3View.class), //

                new MenuItemInfo("Spreadsheet", LineAwesomeIcon.FILE_EXCEL.create(), SpreadsheetView.class), //
